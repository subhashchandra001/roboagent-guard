...
- `request_human_approval`: do not execute until fresh evidence or approval is available.
...
- `GET /capabilities`: supported policy version, actions, decisions, required fields, and scenarios.
